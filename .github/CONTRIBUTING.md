...
## Builds
Our [Travis build](https://travis-ci.org/traderinteractive/filter-floats-php) executes [PHPUnit](http://www.phpunit.de) and uses [Coveralls](https://coveralls.io/) to enforce code coverage.
